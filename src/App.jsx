      ...
      <section className="bg-Sepia dark:bg-gray-900">
        ...
        <div className="grid max-w-screen-xl px-4 py-4 mx-auto lg:gap-8 xl:gap-0 lg:py-8 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7 ">
            ...
            I am highly driven and experienced a bachelor’s degree in International Business Administration and a master’s degree in General Management. I have substantial academic background and job related to business, medicine, and marketing with a proven track record of delivering results with an outstanding ability to make clear and effective management with my team. I have been passionate about digital marketing with eagerness to face challenges and to learn new things.
